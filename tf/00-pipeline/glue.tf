# this will be inside the ecs folder later.
...
resource "aws_glue_crawler" "example" {
  ...
  role          = aws_iam_role.glue.arn
    table_prefix = "stg_"
  s3_target {
    path = "s3://appi-redshift-mixpanel-nonprod/mixpanel/year=2023/"
  }
}
...
# resource "aws_iam_policy_attachment" "sqs_glue" {
#   name       = "SQSForGlue"
#   roles      = [aws_iam_role.glue.name]
#   policy_arn = "arn:aws:iam::aws:policy/AmazonSQSFullAccesss"
# }
